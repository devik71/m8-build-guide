...
const range=o=>o.low===null?'лише пошук':`${uah(o.low)}–${uah(o.high)}`;
const native=o=>o.low===null?'за оголошенням':`${o.rawLow}–${o.rawHigh} ${o.unit}`;
...
fs.writeFileSync('docs/prices.md','# БД цін: Україна ↔ AliExpress\n\n'
 ...
 +table.map(r=>`### ${r.item.name}\n\n| Вендор | Канал | За одиницю, ₴ | У валюті продавця | Пошук |\n|---|---|---:|---|---|\n`
   +r.rows.map(o=>`| ${safe(o.vendor.name)} | ${channelById(o.channel).short} | ${range(o)} | ${native(o)} | [запит](${searchUrl(o.vendor,o.q)}) |`).join('\n')
